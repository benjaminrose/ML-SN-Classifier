...
def parse_args(argv):
    ...
    parser.add_argument('--ft', 
                        choices=['c','x0','x1','t0','z','chi2','fit_pr','gpeak','rpeak','ipeak','zpeak','ra','dec', 'grpeak_m', 'ripeak_m', 'izpeak_m','grpeak_s','ripeak_s','izpeak_s','Deltagr','Deltari','Deltaiz','snr1','snr2','snr3','t0_err','x0_err','x1_err','c_err','Bazin_g_t_rise','Bazin_g_t_fall','Bazin_r_t_rise', 'Bazin_r_t_fall', 'Bazin_i_t_rise', 'Bazin_i_t_fall', 'Bazin_z_t_rise', 'Bazin_z_t_fall', 'grBazin','riBazin','izBazin'],
    ...
    parser.add_argument('--withhold',choices=['20','21','22','32','33','201','204','208','210','213','214','215','216','219','220','221','222','223','224','225','226','227','228','229','230','231','232','233','235','206','209','002','103','104','105','202','203','212','234','021','022','101','102','205','207','211','217','218'], 
                        nargs='+', default='', 
